...
Algorithms, invented for the retrieval of visual data from regular images, are examined in the second section. 
Moreover, there are two classes of information visualization methods are to be distinguished, namely, simple resizing and collages, the latter combining the most important parts of the image. 
In the following, !some! of these methods are compared.

\section{Processing as UI}
When the input is a screenshot, there is a high chance that the usual UI elements are shown on the screen.
