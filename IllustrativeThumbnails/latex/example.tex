...
\begin{document}
	...
	\begin{abstract}
		...
		Screenshots of windows are reduced by cropping the irrelevant elements of the margin area, by seam carving, i.e. by eliminating the non-important pixel paths; and by common down-sampling.
		As a result the thumbnails, compared to classic thumbnails, show more relevant information,
